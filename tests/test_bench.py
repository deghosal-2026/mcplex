            ...
            "rules": [
                {
                    ...
                    "passed": True,
                    "evidence": "No hallucinated API calls detected",
                },
                {
                    "name": "missing-error-handling",
                    "passed": True,
                    "evidence": "All error paths handled",
                },
                {
    ...
    return JSONResponse(
        {
            ...
            "failure_patterns": [
                {
                    "pattern": "flakey test timeout",
                    "frequency": 12,
                    "last_seen": "2026-07-19",
                },
                {
                    "pattern": "dependency download failure",
                    "frequency": 4,
...
HISTORY = [
    {
        ...
        "service": "payment-service",
        "date": "2026-06-28",
        "root_cause": "Connection leak in order worker",
        "resolved": True,
    },
    {
        "id": "INC-2026-105",
        "title": "Deploy caused 5xx spike",
        "severity": "sev1",
        "service": "api-gateway",
        "date": "2026-07-02",
        "root_cause": "Missing env var in new release",
        "resolved": True,
    },
]
